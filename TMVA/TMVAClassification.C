...
//	TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile, "!V:!Silent:Color:!DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=Classification" ); 
	...
	dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
	                                     "nTrain_Signal=18400:nTrain_Background=18400:nTest_Signal=4600:nTest_Background=4600:SplitMode=Random:NormMode=NumEvents:!V" );
	...
	if (Use["DNN_CPU"] or Use["DNN_GPU"]) {
	   // General layout.
	   TString layoutString ("Layout=RELU|128,RELU|64,RELU|32,SIGMOID");

	   // Training strategies.
	   
           TString training3("LearningRate=1e-2,Repetitions=1,"
